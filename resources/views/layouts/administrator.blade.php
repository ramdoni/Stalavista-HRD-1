  ...
  <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="{{ route('administrator.karyawan.index') }}"><i class="la la-users"></i><span class="menu-title" data-i18n="nav.dash.main">Employee</span></a></li>
        <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title" data-i18n="nav.templates.main">Workflow Monitoring</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="{{ route('administrator.cuti.index') }}">Leave Employee</a></li>
            <li><a class="menu-item" href="{{ route('administrator.payment-request.index') }}">Payment Request</a></li>
            <li><a class="menu-item" href="{{ route('administrator.medical.index') }}">Medical Reimbursement</a></li>
            <li><a class="menu-item" href="{{ route('administrator.overtime.index') }}">Overtime Sheet</a></li>
            <li><a class="menu-item" href="{{ route('administrator.exit-interview.index') }}">Exit Interview & Clearance</a></li>
            <li><a class="menu-item" href="{{ route('administrator.training.index') }}">Training & Business Trip</a></li>
          </ul>
        </li>
        <li class=" nav-item"><a href="#"><i class="la la-columns"></i><span class="menu-title">Organization Structure</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="{{ route('administrator.directorate.index') }}">Directorate</a></li>
            <li><a class="menu-item" href="{{ route('administrator.division.index') }}">Division</a></li>
            <li><a class="menu-item" href="{{ route('administrator.department.index') }}">Department</a></li>
            <li><a class="menu-item" href="{{ route('administrator.section.index') }}">Section / Unit</a></li>
            <li><a class="menu-item" href="{{ route('administrator.position.index') }}">Position</a></li>
          </ul>
        </li>
        <li class=" nav-item"><a href="#"><i class="la la-gear"></i><span class="menu-title">Setting</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="{{ route('administrator.setting.index') }}">General</a></li>
            <li><a class="menu-item" href="{{ route('administrator.cabang.index') }}">Branch</a></li>
            <li><a class="menu-item" href="{{ route('administrator.kabupaten.index') }}">Kabupaten / Kota</a></li>
            <li><a class="menu-item" href="{{ route('administrator.bank.index') }}">Bank</a></li>
            <li><a class="menu-item" href="{{ route('administrator.alasan-pengunduran-diri.index') }}">Reasons for Resignation</a></li>
            <li><a class="menu-item" href="{{ route('administrator.setting-master-cuti.index') }}">Leave</a></li>
            <li><a class="menu-item" href="{{ route('administrator.cuti-bersama.index') }}">National Leave</a></li>
            <li><a class="menu-item" href="{{ route('administrator.absensi.index') }}">Attendance</a></li>
            <li><a class="menu-item" href="{{ route('administrator.libur-nasional.index') }}">National Holiday</a></li>
            <li><a class="menu-item" href="{{ route('administrator.plafond-dinas.index') }}">Plafond Training & Business Trip</a></li>
          </ul>
        </li>
        <li class=" nav-item"><a href="#"><i class="la la-gear"></i><span class="menu-title">Setting Education</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="{{ route('administrator.universitas.index') }}">Perguruan Tinggi</a></li>
            <li><a class="menu-item" href="{{ route('administrator.program-studi.index') }}">Program Studi</a></li>
          </ul>
        </li>
        <li class=" nav-item"><a href="#"><i class="la la-gear"></i><span class="menu-title">Setting Approval Form</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="{{ route('administrator.setting-cuti.index') }}">Leave Employee</a></li>
            <li><a class="menu-item" href="{{ route('administrator.setting-payment-request.index') }}">Payment Request</a></li>
            <li><a class="menu-item" href="{{ route('administrator.setting-medical.index') }}">Medical Reimbursement</a></li>
            <li><a class="menu-item" href="{{ route('administrator.setting-overtime.index') }}">Overtime Sheet</a></li>
            <li><a class="menu-item" href="{{ route('administrator.setting-training.index') }}">Training & Business Trip</a></li>
            <li><a class="menu-item" href="{{ route('administrator.setting-exit-clearance.index') }}">Exit Clearance Management</a></li>
          </ul>
        </li>
        <li class=" nav-item"><a href="#"><i class="la la-gear"></i><span class="menu-title">News List / Memo</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="{{ route('administrator.news.index') }}">News</a></li>
            <li><a class="menu-item" href="{{ route('administrator.internal-memo.index') }}">Internal Memo</a></li>
            <li><a class="menu-item" href="{{ route('administrator.peraturan-perusahaan.index') }}">Product Information</a></li>
          </ul>
        </li>
        <li class=" nav-item">
